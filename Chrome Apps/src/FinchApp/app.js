(function () {
  ...
  function openScratch(){
    chrome.browser.openTab({
      url: 'http://scratchx.org/?url=http://sky1e.github.io/Chrome-Scratch-and-Snap-Support/Scratch%20Plugins/FinchHID_Scratch(Chrome%20Plugin).js'
    });
  }
    ...
    var sortMessages = function (data) {
        ...
        if (data_array[7] === "T".charCodeAt()) {
            ...
            sensor_nums = [Math.round(data_array[0] / 2.55), Math.round(data_array[1] / 2.55)];
        }
        else if (data_array[7] === "I".charCodeAt()) {
            sensor_nums.obstacles = data_array;
        }
